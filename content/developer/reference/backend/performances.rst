...
How to make a piece of code run as fast as possible? This page will hopefully give tips and tools to achieve this goal.
...
TODO VSC: change the image to show the debug menu that leads to this popup
...
Example model in `odoo/addons/your_module/populate/custom_model.py`
-------------
